...
class DropGoal: public KinectGoal {
 public:
   ...
   */
  explicit DropGoal(const kinect_goal_definitions::LimitedPose &drop_pose_goal,
   ...
   * @param description descritpion with additional info
   */
  explicit DropGoal(const kinect_goal_definitions::BoundingBox &bounding_box_goal,
 ...
 private:
  /**
   * Adjusts height generated by graspPoseGenerator to accomodate for bounding box height
   * @param bounding_box bounding box og object
  */
