...
DropGoal::DropGoal(const goal_input::BoundingBox &bounding_box_goal, const std::string &description)
...
void DropGoal::adjustHeight(const jaco_manipulation::goals::goal_input::BoundingBox &bounding_box) {
